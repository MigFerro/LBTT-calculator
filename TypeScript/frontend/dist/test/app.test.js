...
test('calculates LBTT with 2 rate bands', () => {
    let lbtt = new calculator_logic_1.LBTT(0, new calculator_logic_1.RateBand(50000, 0.05), new calculator_logic_1.RateBand(20000, 0.01));
...
test('calculates LBTT for 2021 with price below £145,000.00', () => {
    let lbtt = calculator_logic_1.LBTTCalculator_2021;
